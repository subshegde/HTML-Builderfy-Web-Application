...
<body>
    ...
    <section id="leader">
        ...
        <div class="std" id="std" style="visibility: inherit; opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
            ...
            <span class="hb">Subrahmanya </span>
            <!-- <span class="is">Hegde</span> -->
            </a>
            <p class="-purple">Devloper</p>
            <p class="-gray">MCA at Manipal Institute of Technology,Manipal</p>
            <p class="-gray">Gmail: subrahmanyahegde460@gmail.com</p>
            <p class="-gray">Udupi,Karnataka,India</p>
